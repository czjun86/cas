...
.gis-tk{width:430px;margin:0px; padding:0px;border-collapse:collapse; font-family:Arial; color:#5d5d5d;border-top:1px  solid #BFBFBF}
...
<div id="select-cond" style="display:none">
	<a href="javascript:void(0)" class="easyui-linkbutton cond_">确定</a>
	<a href="javascript:void(0)" class="easyui-linkbutton" onclick="javascript:$('#cond').dialog('close')">取消</a>
</div>
<input type="hidden"  value="<#if cell??>${cellVo.areas!''}<#else>''</#if>" id="stationareaids"/>
<input type="hidden"  value="<#if cell??>${cellVo.nettype!'0,1'}<#else>'0,1'</#if>" id="cellnettype"/>
<input type="hidden"  value="<#if cell??>${cellVo.indoor!'0,1'}<#else>'0,1'</#if>" id="cellindoor"/>
<input type="hidden"  value="<#if cell??>${cellVo.cellBands!'900,1800'}<#else>'900,1800'</#if>" id="cellcellbands"/>
</@body>
<@script>
	...
	<!--  <script type="text/javascript" src="${application.getContextPath()}/js/baidumap/MapWrapper.min.js"></script>  --> 
    <script type="text/javascript" src="${application.getContextPath()}/js/baidumap/TextIconOverlay_min.js"></script> 
    <script type="text/javascript" src="${application.getContextPath()}/js/baidumap/MarkerClusterer.min.js"></script> 
	<script type="text/javascript" src="${application.getContextPath()}/js/baidumap/convertor.js"></script>  
    <script type="text/javascript" src="${application.getContextPath()}/js/baidumap/DrawingManager.js"></script>
	...
	<script src="${application.getContextPath()}/js/gisgrad/gisgrad_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/gisgrad/gradquery.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/gisgrad/gradExport.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/gisgrad/station_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/gisgrad/regionBox_baidu.js" type="text/javascript"></script>
	<script>
		var regionCondition;//框选条件
		var contextPath = '${application.getContextPath()}';
		var colorversion = '${colorversion}';
		//0 修正 1原始的
		var sctype = '${sctype}';
		var grap_;
		var grap_=new Object();
		   grap_.inside = '${inside!-1}';
		   grap_.grad = '${grad!-1}';
		   grap_.startTime = '${startTime!}';
		   grap_.endTime = '${endTime!}';
		   grap_.areaids = '${areaids!-1}';
		   grap_.areatext = '${areatext!'全部'}';
		   grap_.senceids = '${senceids!-1}';
		   grap_.senctext = '${senctext!'全部'}';
		   grap_.testtype = '${testtype!-1}';
		   grap_.testtypeText = '${testtypeText!'全部'}';
		   grap_.nettype='${nettype!-1}';
		   grap_.datatype='${datatype!1}';
		   grap_.jobtype='${jobtype!-1}';
		   grap_.kpi='${kpi!-1}';
		   grap_.sernos='${sernos!''}';
		   grap_.testnet = '${testnet!-1}';
		   grap_.testnetName = '${testnetName!'全部'}';
		var grap_s=new Object();
		   grap_s.inside = '${inside!-1}';
		   grap_s.grad = '${grad!-1}';
		   grap_s.startTime = '${startTime!}';
		   grap_s.endTime = '${endTime!}';
		   grap_s.areaids = '${areaids!-1}';
		   grap_s.areatext = '${areatext!'全部'}';
		   grap_s.senceids = '${senceids!-1}';
		   grap_s.senctext = '${senctext!'全部'}';
		   grap_s.testtype = '${testtype!-1}';
		   grap_s.testtypeText = '${testtypeText!'全部'}';
		   grap_s.nettype='${nettype!-1}';
		   grap_s.datatype='${datatype!1}';
		   grap_s.jobtype='${jobtype!-1}';
		   grap_s.kpi='${kpi!-1}';
		   grap_s.sernos='${sernos!''}';
		   grap_s.testnet = '${testnet!-1}';
		   grap_s.testnetName = '${testnetName!'全部'}';
	</script>
</@script>

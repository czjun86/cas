...
<@script>
	...
	<script src="${application.getContextPath()}/js/gisgrad/gisgrad.js" type="text/javascript"></script>
	...
	<script src="${application.getContextPath()}/js/gisgrad/station.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/gisgrad/regionBox.js" type="text/javascript"></script>
	<script>

...
<@script>
	...
	<script src="${application.getContextPath()}/js/report/indoorMap_google.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/report/outdoorMap_google.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/report/station_google.js" type="text/javascript"></script>

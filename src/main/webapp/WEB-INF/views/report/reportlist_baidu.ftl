...
<img src="../images/jbar.gif" /></span>
	...
	<!--========报表中间开始========= -->
	  ...
	  <table class="mytable" width="100%" id="temptable1" height="280"  style="display:none" border="0" cellspacing="0" cellpadding="0">
	  	<tr>
	  		<td width="15%">工单流水号：</td>
	  		<td width="20%"><p><span id="ss_id">${s.serialno!}</span>
	  		<#if s.verify?? && s.verify == 0><span class='verify_sty' style="float:right;width:40px;color:white;text-align:center;margin-right:5px;background:url('${application.getContextPath()}/images/bg_0.png') no-repeat scroll 0 0 rgba(0, 0, 0, 0);">未审核</span></#if>
	...
	<!--========报表头部========= -->
	  ...
	  <ul>
		...
		<li class="<#if netType?? && netType==3>forms_nav_now netType</#if> netclass" netValue="3">LTE</li>	      
	...
	<!--========报表头部二级结束========= -->
	 <!--测试结果开始 -->
		...
		<div style="display:none;"  id="dlg-isverify">
	  ...
	  <div class="forms_center">
	    ...
	    <div class="forms_data">
	    	<div class="svg-div-title">	    	
		       ...
		       <span id="s_sel3" style="display:none"> <select id="SelectBox3"  class="easyui-combobox" style="width:100px;" data-options="editable:false,panelHeight: 'auto'"></select></span>
...
<@script>
	...
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=WrMcR9V4PmcYTP226GGd6VRM"></script>
	...
	<script type="text/javascript" src="${application.getContextPath()}/js/report/map.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/report/report.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/report/utile_report.js"></script>
	...
	<script type="text/javascript" src="${application.getContextPath()}/js/report/kpi_selectBox.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/report/trck.js"></script>
	...
	<script src="${application.getContextPath()}/js/report/indoorMap_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/report/outdoorMap_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/report/station_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/report/reportExcel.js" type="text/javascript"></script>
	<script>

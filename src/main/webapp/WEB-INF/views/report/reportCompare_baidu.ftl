...
<script type="text/javascript" src="${application.getContextPath()}/js/report/compare/compareReport.js"></script>
<script type="text/javascript" src="${application.getContextPath()}/js/report/utile_report.js"></script>
<script type="text/javascript" src="${application.getContextPath()}/js/report/compare/point_baidu.js"></script>

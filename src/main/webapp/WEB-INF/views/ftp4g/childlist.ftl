 <#if list?? &&  list?size &gt; 0>
	<#list list as ftp>
		 <ul <#if ftp_index%2 == 1>class="all_list_background"</#if> >
          ...
          <li style="width:10%" title="${(ftp.file_size)!}(Bytes)">${(ftp.file_size)!}(Bytes)</li>
          <li style="width:22%" class="all_list_riborder">

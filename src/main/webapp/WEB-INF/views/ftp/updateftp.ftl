...
<@body>
	<div class="right">
	  <div class="sys_use" style="width:98%;margin-left:1%">
	      <!-----搜索框 开始 ------->
	      <form action="${application.getContextPath()}/ftp/updateFtp" id="searchForm" method="post">
	      ...
	      <div class="all_list">
	        ...
	        <ul class="all_list_ts">
	          ...
	          <li style="width:24%" class="all_list_tsright">操作</li>
	        </ul>
	        <div id="content">
				<ul>
...
<@script>
	...
	<script type="text/javascript" src="${application.getContextPath()}/js/ftp/validater.js"></script>
	...
	<script src="${application.getContextPath()}/js/ftp/update.js" type="text/javascript"></script>
	<script>

...
<@script>
	...
	<script src="${application.getContextPath()}/js/reportIndependent/indoorMap_google.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/reportIndependent/outdoorMap_google.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/reportIndependent/station_google.js" type="text/javascript"></script>

	...
	<!--========报表中间开始========= -->
	  ...
	  <table class="mytable" width="100%" id="temptable1" height="116"  style="display:none" border="0" cellspacing="0" cellpadding="0">
	  	...
	  	<tr style="display:none;">
  			<td>网络类型：</td>
	  		<td  colspan="3" name="exc_netType">${s.netWorktype!}</td>
	  	</tr>
	  	<tr style="display:none;">
	  		<td>派单员工号：</td>
...
<@script>
	...
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/highcharts1.0.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/ReportForms.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/raphael.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/map.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/report.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/utile_report.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/graphicEle.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/scatter.js"></script>
	<script type="text/javascript" src="${application.getContextPath()}/js/reportIndependent/trck.js"></script>
	...
	<script src="${application.getContextPath()}/js/reportIndependent/indoorMap_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/reportIndependent/outdoorMap_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/reportIndependent/station_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/reportIndependent/reportExcel.js" type="text/javascript"></script>
	<script>

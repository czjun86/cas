...
<@script>
	...
	<script src="${application.getContextPath()}/js/reportTask/indoorMap_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/reportTask/outdoorMap_baidu.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/reportTask/station_baidu.js" type="text/javascript"></script>

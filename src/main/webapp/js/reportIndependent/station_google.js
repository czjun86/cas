	...
	_infowindow.close();
	 $.post(contextPath + "/gisgrad/showContent",
				...
				function(data){
					...
					var html="";
					if(cell.modetype==0){
						 html = new EJS({url: contextPath+'/js/reportIndependent/cell_info.ejs'}).render(cell);
					}else if(cell.modetype==1){
						html = new EJS({url: contextPath+'/js/reportIndependent/cell_info_gsm.ejs'}).render(cell);
					}

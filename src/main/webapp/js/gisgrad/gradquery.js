...
function initeTestType(){
	$("#testtypes").combobox({
		onShowPanel:function(){
			...
			$.parser.parse('#nettype');
			var src = contextPath + '/gisgrad/testtypelist?testtype='+$("#testtype").val()+'&nettype='+$("#nettype").combobox('getValue');
			$("#testtypedlg").dialog({
				href:src,
...
function initeTestnets(){
	$("#testnets").combobox({
		onShowPanel:function(){
			...
			$.parser.parse('#nettype');
			var src = contextPath + '/gisgrad/testNetlist?nettype='+$("#nettype").combobox('getValue')+'&testnet='+$("#testnet").val();
			$("#testnetdlg").dialog({
				href:src,

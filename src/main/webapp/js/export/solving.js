$(function(){
	...
	$("#areas").combobox({
		onShowPanel : function() {
			...
			var ids = $("#queryids").val();
			var src = contextPath + '/solving/arealist?areaids='+ids;
			$("#areadlg").dialog({
				href:src,
	...
	$("#leadExcel").click(function(){
		...
		if(area_id!=''&&typeof(area_id)!='undefined'){
			if(validateTime(t_type,s_time,e_time,m_time)){
				var url = contextPath+"/solving/download?area_id="+area_id+"&s_time="+s_time+"&e_time="+e_time+"&m_time="+m_time+"&t_type="+t_type;

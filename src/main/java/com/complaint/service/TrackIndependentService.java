...
import com.complaint.dao.TrackIndependentDao;
...
@Service("trackIndependentService")
public class TrackIndependentService {
	@Autowired
	private TrackIndependentDao trackIndependentDao;
    ...
    public List<WcdmsTrackLog> queryWcdma(String id,String areaid)
    {
		...
		return this.trackIndependentDao.queryWcdma(map);
    }
    /***
	 * 查询GSM日志服务信息
	 * @param map 流水号
    ...
    public List<LogSubmanualGsm> queryGsm(String id,String areaid)
    {
		...
		map.put("id",id);
		map.put("areaid",areaid);
		return this.trackIndependentDao.queryGsm(map);
    }
   ...
   public List<TrackCell> queryCell(String flowid,String areaid){
		...
		map.put("areaid",areaid);
	   return this.trackIndependentDao.queryCell(map);
   }
   /**
    * 查询轨迹图点数据3g*/
   public List<TrackPoint> queryPointWcdma(String flowid,String areaid){
	...
	map.put("areaid",areaid);
	return this.trackIndependentDao.queryPointWcdma(map);
   ...
   public List<TrackPoint> queryPointGsm(String flowid,String areaid){
	...
	map.put("flowid", idlist);
	map.put("areaid",areaid);
	return this.trackIndependentDao.queryPointGsm(map);
   }
   ...
   public List<CenterZoom>  queryCenter(String flowid,String areaid){
	   Map<String, Object> map = new HashMap<String, Object>();
		...
		List<String> idlist = Arrays.asList(flowids);
		map.put("flowid", idlist);
		return this.trackIndependentDao.queryCenter(map);
   }
}

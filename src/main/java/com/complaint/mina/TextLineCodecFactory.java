...
public class TextLineCodecFactory implements ProtocolCodecFactory {
     ...
     */
    public TextLineCodecFactory(String codec) {
        encoder = new TextLineEncoder(Charset.forName(codec), LineDelimiter.UNIX);
        decoder = new TextLineDecoder(Charset.forName(codec), LineDelimiter.AUTO);
    }
